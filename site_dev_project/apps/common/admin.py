...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('name', 'date_publish', 'click_count', 'stages', 'student_count')
    list_editable = ('click_count', 'student_count',)
    inlines = [CourseResourceInline, ]


class MyCourseAdmin(admin.ModelAdmin):
    list_display = ('course', 'course_type')
...
admin.site.register(Person_nav)